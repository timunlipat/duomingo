            ...
            <div className="relative" style={{ right: `${rightPosition}px`, marginTop: isFirst && !isCompleted ? 60 : 24 }}>
                { current ? 
                    <div className="h-[102px] w-[102px] relative">
                        <div className="absolute -top-6 left-2.5 px-3 py-2.5 border-2 font-bold uppercase text-rose-500 bg-white rounded-xl animate-bounce tracking-wide z-10">
                            Start
                        ...
                        >
                            <Button size="rounded" variant={ locked ? "locked" : "danger" } className="h-[70px] w-[70px] border-b-8">
                                <Icon
                                    className={cn(
                                        "h-10 w-10",
                                        locked 
